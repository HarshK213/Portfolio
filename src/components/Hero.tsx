...
function Hero() {
    ...
    // About starts at viewportHeight. Halfway through is viewportHeight + (Abou
    // tHeight / 2).
        ...
        /> */}
            ...
            <div className="relative h-screen w-screen flex justify-center items-center overflow-hidden">
                ...
                >
                    ...
                    <h1 className="text-black dark:text-white font-[Doto] text-[100px] font-extrabold leading-none mb-2">
                        HARSH KUSHWAHA
                    </h1>

                    <p className="text-black/50 dark:text-white/60 mb-4 text-center">
